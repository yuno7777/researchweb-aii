...
type ReportSection = keyof Omit<Report, 'title' | 'erd'>;
...
export function ReportDisplay({ report, onReportUpdate }: ReportDisplayProps) {
  ...
  const [editingSection, setEditingSection] = useState<ReportSection | 'erd' | null>(null);
  ...
  const handleEditClick = (section: ReportSection | 'erd') => {
