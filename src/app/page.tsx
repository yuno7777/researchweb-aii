...
export default function Home() {
  ...
  const handleExportPdf = () => {
    ...
    const fileName = `Brello_Report_${topicTitle.replace(/ /g, '_') || 'Untitled'}.pdf`;
    ...
    try {
        ...
        pdf.text(`Generated by Brello on ${date}`, pdf.internal.pageSize.getWidth() / 2, pageHeight - 20, { align: 'center' });
    ...
    <div className="flex min-h-screen w-full flex-col bg-[hsl(var(--background))] text-foreground" suppressHydrationWarning>
      <header className="sticky top-0 z-50 w-full bg-[hsl(var(--background))]">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
            <h1 className="font-serif text-3xl font-bold text-primary">brello</h1>
            ...
            <div className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center">
              <div className="absolute inset-0 -z-10 overflow-hidden">
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                      ...
                      <h1 className="font-serif text-[30rem] font-bold text-gray-200/50 leading-none">brello</h1>
                  </div>
              </div>
              ...
              <div className="mt-12 text-center max-w-3xl">
                <h2 className="text-xl font-bold">Brello: AI For Researchers, AI Report Generator</h2>
                <p className="text-muted-foreground mt-2">
                  Brello leverages cutting-edge AI models, including OpenAI 4o-mini, GPT-4o, and Gemini, to power its deep research agent and AI report generator, delivering accurate reports and actionable insights for researchers.
                </p>
              </div>
            </div>
